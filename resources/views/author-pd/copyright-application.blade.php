...
@section('pg-title')
<h1><i class="fa fa-envelope"></i> Copyright Registration</h1>
	<p>Apply project for copyright registration</p>
@endsection
@section('breadcrumb-label')
<li class="breadcrumb-item"><a href="/author/apply-project">Copyright Application</a></li>
@endsection
@section('content')
