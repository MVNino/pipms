  ...
  <div class="card">
    <div class="mailbox-controls">
      ...
      <div class="btn-group">
        ...
        <button class="btn btn-danger btn-sm" type="button"><i class="fa fa-reply"></i></button>
        <button class="btn btn-danger btn-sm" type="button"><i class="fa fa-share"></i></button>
        <button class="btn btn-danger btn-sm" type="button"><i class="fa fa-refresh"></i></button>
      </div>
    </div>
    ...
    <div class="text-right"><span class="text-muted mr-2">Showing 1-15 out of 60</span>
      <div class="btn-group">
        <button class="btn btn-danger btn-sm" type="button"><i class="fa fa-chevron-left"></i></button>
        <button class="btn btn-danger btn-sm" type="button"><i class="fa fa-chevron-right"></i></button>
      </div>
    </div>
  </div>
</div>
