...
<head>
  ...
  <!-- FAVICON -->
  <link href="{{ asset('classimax/images/img/favicon.png') }}" rel="shortcut icon">
    ...
    <div class="row">
      <div class="col-lg-3 col-md-7 offset-md-1 offset-lg-0">
        ...
        <div class="block about">
          <!-- footer logo -->
          <img src="{{ asset('classimax/images/logo-footer.png')}}" alt="">
          <!-- description -->
      ...
      <div class="col-lg-4 col-md-7">
        ...
        <div class="block-2 app-promotion">
          <a href="">
            <!-- Icon -->
            <img src="{{ asset ('classimax/images/footer/phone-icon.png')}}" alt="mobile-icon">
          </a>
