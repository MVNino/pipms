<div class="sidebar">
	...
	<div class="widget user-dashboard-menu">
		<ul>
			...
			<li><a href=""><i class="fa fa-envelope"></i> Messages <span>5</span></a></li>
			<li><a href=""><i class="fa fa-file-archive-o"></i>My Account <span>12</span></a></li>
			<li><a href=""><i class="fa fa-bolt"></i> Apply Project<span>23</span></a></li>
			<li><a href=""><i class="fa fa-bolt"></i> My Projects<span>23</span></a></li>
