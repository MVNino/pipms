...
<div class="row">
  <div class="col-md-12">
    <div class="tile">
      <h4 class="tile-head">IPR<small> (Intellectual Property Rights)</small> Records of {{ $branch->str_branch_name }} <small>as of {{ date('F d, Y', strtotime(now())) }}</small></h4>
      <div class="tile-body">
  ...
  <div class="col-md-6">
    <div class="tile">
      ...
      <div class="row container">
        ...
        <div class="col-md-3">
          <a role="button" target="_blank" href="/admin/reports/branch/{{ $branch->int_id }}/ipr-conflicts_pdf/conflict" class="btn btn-primary">
  ...
  <div class="col-md-6">
    <div class="tile">
      ...
      <div class="row container">
        ...
        <div class="col-md-1"></div>
        <div class="col-md-3">
          <a role="button" target="_blank" href="/admin/reports/branch/{{ $branch->int_id }}/ipr-conflicts_pdf/to-submit-conflict" class="btn btn-primary">
            <i class="fa fa-file"></i> Generate PDF
          </a>
        </div>
      </div>
              ...
              <table class="table table-hover table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <a href="/admin/reports/college/{{ $copyright->int_college_id }}">{{ $copyright->char_college_code }}</a> - 
                      <a href="/admin/reports/department/{{ $copyright->int_department_id }}">
                      {{ $copyright->char_department_code }}
                      </a>
                    </td>
...
<div class="tile tile-body mb-1">
  <div class="row">
    <div class="col-md-10">
      <h4 class="text-muted">Generate PDF for {{ $branch->str_branch_name }} Colleges' IPR Records</h4>
    </div>
    <div class="col-md-2">
      <a role="button" target="_blank" href="/admin/reports/branch/{{ $branch->int_id }}/branch-colleges_pdf" class="btn btn-primary">
          <i class="fa fa-file"></i> Generate PDF
        </a>
    </div>
  </div>
