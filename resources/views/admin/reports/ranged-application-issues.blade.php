...
<div class="tile tile-body">
  ...
  <div class="row">
      ...
      <div class="col-md-2">
        <br>
        <a href="{{ route('reports.application-issues') }}" class="btn btn-secondary">Back</a> 
      </div>
      <div class="col-md-2">
        <a role="button" target="_blank" href="/admin/reports/application-issues_pdf/{{ $dateStart }}/{{ $dateEnd }}" class="btn btn-primary float-right">
          ...
          <table class="table table-hover table-bordered" id="sampleTable">
            <thead>
              <tr>
                ...
                <th class="text-center">Date of Schedule</th>
              </tr>
            </thead>
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">
                  @if($copyright->char_copyright_status == 'conflict')
                  {{ date('m/d/Y', strtotime($copyright->dtm_schedule)) }}
                  @elseif($copyright->char_copyright_status == 'to submit/conflict')
                  {{ date('m/d/Y g:iA', strtotime($copyright->dtm_schedule)) }}
                  @endif
                </td>
              </tr>
              @empty
          ...
          <table class="table table-hover table-bordered" id="sampleTable">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">
                  @if($patent->char_patent_status == 'conflict')
                  {{ date('m/d/Y', strtotime($patent->dtm_schedule)) }}
                  @elseif($patent->char_patent_status == 'to submit/conflict')
                  {{ date('m/d/Y g:iA', strtotime($patent->dtm_schedule)) }}
                  @endif
                </td>
              </tr>
              @empty
