      ...
      <div class="tile-body">
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade active show" id="copyright">
              <br>
              <a role="button" target="_blank" href="/admin/reports/branch/{{ $branch->int_id }}/{{ $dateStart }}/{{ $dateEnd }}/copyrights_pdf" class="btn btn-primary float-right">
            ...
            <br>
            <a role="button" target="_blank" href="/admin/reports/branch/{{ $branch->int_id }}/{{ $dateStart }}/{{ $dateEnd }}/patents_pdf" class="btn btn-primary float-right">
              <i class="fa fa-file"> Generate PDF</i>
            </a>
