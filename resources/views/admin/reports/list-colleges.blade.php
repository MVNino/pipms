...
<div class="tile tile-body">
  ...
  {!! Form::open(['action' => 'Report\CollegeController@rangedColleges', 'method' => 'GET', 'autocomplete' => 'off']) !!}
    @csrf
  <div class="row">
      <div class="col-md-4">
      ...
      <div class="col-md-2">
        <a role="button" target="_blank" href="{{ route('colleges-pdf') }}" class="btn btn-primary float-right">
