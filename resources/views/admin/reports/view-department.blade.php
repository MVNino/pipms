...
<div class="row">
  <div class="col-md-12">
    <div class="tile">
      <h4 class="tile-head">IPR<small> (Intellectual Property Rights)</small> Records of {{ $department->char_department_code }} <small>as of {{ date('F d, Y', strtotime(now())) }}</small></h4>
      <div class="tile-body">
  ...
  <div class="col-md-6">
    <div class="tile">
      ...
      <div class="row container">
        ...
        <div class="col-md-3">
          <a role="button" target="_blank" href="/admin/reports/department/{{ $department->int_id }}/ipr-conflicts_pdf/conflict" class="btn btn-primary">
  ...
  <div class="col-md-6">
    <div class="tile">
      ...
      <div class="row container">
        ...
        <div class="col-md-1"></div>
        <div class="col-md-3">
          <a role="button" target="_blank" href="/admin/reports/department/{{ $department->int_id }}/ipr-conflicts_pdf/to-submit-conflict" class="btn btn-primary">
            <i class="fa fa-file"></i> Generate PDF
          </a>
        </div>
      </div>
