...
<div class="col-md-6">
  <div class="tile">
    <div class="tile-title-w-btn">
      ...
      <div class="btn-group"><a class="btn btn-primary" href="/admin/transaction/patent/to-submit/{{ $patent->int_id }}"><i class="fa fa-lg fa-eye"></i></a><a class="btn btn-primary" href="#"><i class="fa fa-lg fa-envelope-o"></i></a><a class="btn btn-primary" href="#"><i class="fa fa-lg fa-thumbs-up"></i></a></div>
    </div>
    <div class="tile-body">
