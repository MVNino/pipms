...
<li class="breadcrumb-item"><a href="/admin/transaction/copyrights/to-submit">On Process Copyright Requests</a></li>
          ...
          <div class="row">
            ...
            <div class="col-md-5">
              <div class="btn-group">
                ...
                <a class="btn btn-primary" href="/admin/transaction/copyright/change-on-process-to-copyrighted/{{ $copyright->int_id }}">
                  <i class="fa fa-lg fa-thumbs-up"></i> Grant copyright</a>
                @endif
              </div>
            </div>
          </div>
